                 ...
                 <div className="accordion-item" style={{backgroundColor:props.mode==='dark'?'rgb(36 41 45)':'white',color : props.mode==='dark'?'white':'black'}}>
                    ...
                    <div className="accordion-item" style={{backgroundColor:props.mode==='dark'?'rgb(36 41 45)':'white',color : props.mode==='dark'?'white':'black'}}>
                        <h2 className="accordion-header" id="headingThree">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style={{backgroundColor:props.mode==='dark'?'rgb(55 65 72)':'white',color : props.mode==='dark'?'white':'black'}}>
                                Accordion Item #3
                            </button>
                        </h2>
