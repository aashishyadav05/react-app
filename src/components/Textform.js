    ...
    return (
        <div className="container" style={{color:props.mode==='dark'?'white':'black'}}>
            ...
            <div className="container">
                ...
                <button disabled={text.length===0} className="btn btn-primary mx-2" onClick={handleUpCLick}>convert the Uppercase</button>
                <button disabled={text.length===0} className="btn btn-primary mx-2" onClick={handleLoCLick}>convert the Lowercase</button>
